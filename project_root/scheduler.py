...
def _build_persona_prompt_and_meta(
    ...
    if gender == "female":
        grammar = (
            ...
            "в конструкциях «я бы…»: сказала, уточнила, поспорила, добавила, отметила, подумала, считала, хотела, сделала, решила. "
            "Никогда: согласен, уверен, удивлён, готов, прав; сказал, уточнил, поспорил, добавил, отметил, подумал, считал, хотел, сделал, решил. "
            "Примеры вводных (разнообразь, не только эти): «Согласна…», «Не уверена…», «Мне кажется…», «Не совсем согласна…», «Я бы сказала…», «Похоже на то», «Тут есть нюанс», «Сомневаюсь», или начало сразу по делу."
        )
    else:
        grammar = (
