    ...
    def generate_user_reply(
        ...
        *,
        ...
        common_rules = (
            ...
            "- Не копируй формулировки пользователя — перефразируй своими словами.\n"
            "- Реагируй на 1 конкретную деталь сообщения (слово/факт/часть вопроса), не пересказывай весь вопрос.\n"
            "- Допустимы вводные: «Скорее всего…», «Честно говоря…», «Не уверен…», «Ну тут спорно…», «Мне кажется…» — но не всегда начинай с них: чередуй с ответами сразу по делу.\n"
