    ...
    def generate_user_reply(
        ...
        *,
        ...
        common_rules = (
            ...
            "- Не повторяй формулировки пользователя дословно — перефразируй.\n"
            "- Реагируй на 1 конкретную деталь сообщения (слово/факт/часть вопроса), не пересказывай весь вопрос.\n"
            "- Допустимы вводные: «Скорее всего…», «Честно говоря…», «Не уверен…», «Ну тут спорно…», «Мне кажется…».\n"
        ...
        # Пресеты манеры ответа (веса: сумма 100; вопрос и ультра-короткий реже)
        presets = [
            "Формат: одно короткое предложение. Чётко займи позицию: согласие или сомнение.",
            "Формат: 1–2 предложения. Начни с уточнения или лёгкого несогласия: «Я бы не упрощал», «Не факт», «Ну спорно» — затем кратко поясни.",
        ...
        weights = [23, 23, 22, 12, 10, 10]  # 1 позиция 23%; 2 "не упрощал" 23%; 3 пример 22%; 4 вопрос 12%; 5 ультра 10%; 6 мягк.несогл. 10%
