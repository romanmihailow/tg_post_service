    ...
    def generate_discussion_messages(
        ...
        *,
        ...
        question_variety_hint = (
            "Вопрос ведущего (поле question) формулируй по-разному: не только «Как думаете», «Что вы об этом думаете?». "
            "Варианты тона/формы (выбери один по смыслу или свой в том же духе): "
